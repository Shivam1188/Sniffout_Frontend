...
export default function DashboardCards() {
  ...
  const cards: any = [
    ...
    stats.calls && {
      ...
      change: formatChange(stats.calls.trend, stats.calls.percentage_change),
      bg: stats.calls.trend === "up" ? "bg-orange-100" : "bg-red-100",
      text: "text-orange-900",
      badge: stats.calls.trend === "up" ? "text-orange-700" : "text-red-700",
    },
    stats.duration && {
  ...
  const SkeletonCard = () => (
    <div className="p-4 md:p-6 rounded-xl shadow-md border border-gray-200 animate-pulse">
      ...
      <div className="h-10 bg-gray-300 rounded w-1/2 mb-1"></div>

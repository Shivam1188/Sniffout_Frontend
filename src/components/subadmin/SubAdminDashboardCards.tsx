...
export default function SubadminDashboardCards() {
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 md:gap-6 mb-2">
      {loading
        ? Array(4)
            .fill(0)
            .map((_, index) => (
              <div
                key={index}
                className="p-4 md:p-6 rounded-xl shadow-md border border-gray-200 animate-pulse bg-gray-200 h-40"
              ></div>
            ))

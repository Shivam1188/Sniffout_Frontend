    ...
    <div className="min-h-screen flex bg-gray-50 text-gray-800 font-sans">
      <div className="flex-1 p-6">
        <div className="table-sec bg-gradient-to-br from-[#f3f4f6] to-white sm:p-6 p-3 rounded-xl shadow-md border border-gray-200">
          ...
          <div className="min-h-screen flex items-center justify-center bg-gradient-to-r from-[#fe6a3c] to-[#1d3faa] px-4 py-5 sm:px-6 ">
            <div className="relative p-[2px] rounded-2xl bg-gradient-to-r from-[#fe6a3c] via-[#1d3faa] to-[#fe6a3c] w-full max-w-xl">
              <div className="bg-white dark:bg-gray-900 rounded-2xl p-3 sm:p-12  w-full">
                <h2 className="text-xl md:text-3xl lg:text-4xl sm:text-4xl font-extrabold text-gray-800 dark:text-white text-center mb-8">
                  Add Menu Item
                </h2>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <button
                    type="submit"
                    disabled={loading}
                    className="cursor-pointer w-full bg-gradient-to-r from-[#fe6a3c] via-[#ff884d] to-[#fe6a3c] text-white font-semibold py-3 px-6 rounded-lg shadow-lg transition duration-300"
                  >

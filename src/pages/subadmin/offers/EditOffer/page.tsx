// src/pages/subadmin/offers/EditOffer.tsx
...
const EditOffer: React.FC = () => {
    ...
    try {
      ...
      if (response.success) {
        ...
        setFormData({
          ...
          discount_percentage: offerData.discount_percentage || 20,
          discount_amount: offerData.discount_amount || "",
          minimum_order_value: offerData.minimum_order_value || "",
          applicable_items: offerData.applicable_items || "",
          ...
          valid_time_start: offerData.valid_time_start || "",
          valid_time_end: offerData.valid_time_end || "",
          max_redemptions: offerData.max_redemptions,
          redemption_limit_per_user: offerData.redemption_limit_per_user,
          daily_limit: offerData.daily_limit || "",
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await apiService.updateOffer(parseInt(id!), submitData);
            ...
            <div className="bg-white p-6 sm:p-8 rounded-2xl shadow-xl border-t-4 border-[#fe6a3c]">
              <form onSubmit={handleSubmit} className="space-y-8">
                ...
                <div className="flex justify-end pt-6 border-t border-gray-200">
                  <button
                    type="submit"
                    disabled={submitting || completedSteps.length < 4}
                  ...
                  >
                    <Save size={20} />
                    {submitting ? "Updating Offer..." : "Update Offer"}
                  </button>
                </div>
              </form>
            </div>

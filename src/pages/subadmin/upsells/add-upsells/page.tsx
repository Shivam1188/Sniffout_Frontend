  ...
  return (
    <div className="min-h-screen flex bg-gray-50 text-gray-800 font-sans">
      <div className="flex-1 p-6">
        <div className="flex flex-col md:flex-row  bg-[#4d519e] gap-4 sm:gap-5 p-4 rounded-2xl mb-4  justify-end">
          <Link
            to="/subadmin/upsells"
          ...
          <div className=" flex items-center justify-center px-2 sm:px-6 lg:px-8 animate-fadeIn">
            <div className="relative p-[2px] rounded-2xl bg-gradient-to-r from-[#fe6a3c] via-[#1d3faa] to-[#fe6a3c] animate-borderMove w-full max-w-xl">
              <div className="bg-white  rounded-2xl p-5 sm:p-12 w-full transform transition-all duration-500 hover:scale-[1.02] h-[600px] overflow-y-scroll">
                <h2 className="text-xl sm:text-2xl font-extrabold text-gray-800 text-center mb-8 animate-slideInDown">
                  Add Upselling Offer
                </h2>

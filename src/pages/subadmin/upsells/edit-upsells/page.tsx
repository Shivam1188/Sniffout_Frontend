        ...
        <div className="table-sec bg-gradient-to-br from-[#f3f4f6] to-white p-3 sm:p-6 rounded-xl shadow-md border border-gray-200">
          <div className="flex items-center justify-center px-2 sm:px-6 lg:px-8 animate-fadeIn">
            <div className="relative p-[2px] rounded-2xl bg-gradient-to-r from-[#fe6a3c] via-[#1d3faa] to-[#fe6a3c] animate-borderMove w-full max-w-xl">
              <div className="bg-white d rounded-2xl p-5 sm:p-12 w-full transform transition-all duration-500 hover:scale-[1.02] h-[600px] overflow-y-scroll">
                <h2 className="text-xl sm:text-3xl font-extrabold text-black  text-center mb-8 animate-slideInDown">
